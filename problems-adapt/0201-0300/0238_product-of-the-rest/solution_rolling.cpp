...
class Solution {
  public:
    vector<CoderPuzzleBig> productOfRest(vector<int> &nums) {
        ...
        int n = nums.size();
        vector<CoderPuzzleBig> answer(n, coderpuzzleBigOne());
